 ...
 */
export const listVehicles = (params?: ListVehiclesParams, signal?: AbortSignal) => {
  return axiosInstance<VehicleDto[]>({ url: `/api/v1/vehicles`, method: 'GET', params, signal });
};

export const getListVehiclesQueryKey = (params?: ListVehiclesParams) => {
  return [`/api/v1/vehicles`, ...(params ? [params] : [])] as const;
};
...
>(
  ...
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof listVehicles>>, TError, TData>>;
  },
) => {
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof listVehicles>>> = ({ signal }) =>
    listVehicles(params, signal);
...
export function useListVehicles<
  ...
  TError = ErrorType<unknown>,
>(
  params: undefined | ListVehiclesParams,
  options: {
    query: Partial<UseQueryOptions<Awaited<ReturnType<typeof listVehicles>>, TError, TData>> &
      Pick<
        DefinedInitialDataOptions<
 ...
 * @summary Create a vehicle (admin or operator-scoped)
 */
export const useCreateVehicle = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof createVehicle>>,
      TError,
...
export const getVehicle = (id: number, signal?: AbortSignal) => {
  return axiosInstance<VehicleDto>({ url: `/api/v1/vehicles/${id}`, method: 'GET', signal });
};
...
>(
  id: number,
  options?: {
    query?: Partial<UseQueryOptions<Awaited<ReturnType<typeof getVehicle>>, TError, TData>>;
  },
) => {
  const { query: queryOptions } = options ?? {};
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getVehicle>>> = ({ signal }) =>
  ...
  return {
    ...
    staleTime: 30000,
    ...queryOptions,
  } as UseQueryOptions<Awaited<ReturnType<typeof getVehicle>>, TError, TData> & {
    queryKey: DataTag<QueryKey, TData, TError>;
  };
};
 ...
 * @summary Update a vehicle (admin or owning operator)
 */
export const useUpdateVehicle = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof updateVehicle>>,
      TError,
 ...
 */
export const deleteVehicle = (id: number, signal?: AbortSignal) => {
  return axiosInstance<void>({ url: `/api/v1/vehicles/${id}`, method: 'DELETE', signal });
};
...
> => {
  ...
  const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteVehicle>>, { id: number }> = (
    props,
  ) => {
    const { id } = props ?? {};
 ...
 * @summary Delete a vehicle (admin or owning operator) — 409 if active trips exist
 */
export const useDeleteVehicle = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof deleteVehicle>>,
      TError,
