 ...
 */
export const registerUser = (registerBodyDto: BodyType<RegisterBodyDto>, signal?: AbortSignal) => {
 ...
 */
export const loginUser = (loginBodyDto: BodyType<LoginBodyDto>, signal?: AbortSignal) => {
  return axiosInstance<AuthSessionDto>({
 ...
 */
export const refreshTokens = (refreshBodyDto: BodyType<RefreshBodyDto>, signal?: AbortSignal) => {
 ...
 * @summary Exchange refresh token for new pair
 */
export const useRefreshTokens = <TError = ErrorType<unknown>, TContext = unknown>(
  options?: {
    mutation?: UseMutationOptions<
      Awaited<ReturnType<typeof refreshTokens>>,
      TError,
