...
import { SeatLayoutDeleteDialog } from '@/components/seat-layouts/seat-layout-delete-dialog';
import { SeatLayoutFormDialog } from '@/components/seat-layouts/seat-layout-form-dialog';
              ...
              <TableRow key={layout.id}>
                ...
                <TableCell>
                  <div className="flex items-center gap-2">
                    <Button size="sm" variant="outline" onClick={() => handleEdit(layout)}>
                      Edit
                    </Button>
                    <Button
                      size="sm"
