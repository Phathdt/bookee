        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        data-testid="vehicle-form-company-id-input"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      {...field}
                      data-testid="vehicle-form-plate-number-input"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Sleeper, Limousine, Express…"
                      {...field}
                      data-testid="vehicle-form-type-input"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    <FormControl>
                      <SelectTrigger data-testid="vehicle-form-seat-layout-id-select">
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      ...
                      value={field.value}
                      onChange={(e) => field.onChange(e.target.valueAsNumber)}
                      data-testid="vehicle-form-total-seats-input"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={isPending} data-testid="vehicle-form-submit">
