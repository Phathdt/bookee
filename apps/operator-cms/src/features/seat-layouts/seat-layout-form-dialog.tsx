          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input
                      placeholder="Sleeper 40 seats"
                      {...field}
                      data-testid="seat-layout-form-name-input"
                    />
                  </FormControl>
                  <FormMessage />
                </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        data-testid="seat-layout-form-rows-input"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        ...
                        value={field.value}
                        onChange={(e) => field.onChange(e.target.valueAsNumber)}
                        data-testid="seat-layout-form-cols-input"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        ...
                        {...field}
                        data-testid="seat-layout-form-seats-json-textarea"
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
            ...
            <DialogFooter>
              <Button
                ...
                data-testid="seat-layout-form-cancel"
              >
                Cancel
              </Button>
              <Button type="submit" disabled={isPending} data-testid="seat-layout-form-submit">
